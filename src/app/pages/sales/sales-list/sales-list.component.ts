...
export class SalesListComponent implements OnInit {
  ...
  private getAllNewSales() {
    ...
    this.subDataOne = this.newSalesService
      .getAllNewSales({ ...{ soldDateString: { $gte: startDate, $lte: endDate } }, ...filter }, null)
      .subscribe({
        next: (res) => {
          // console.log(res)
          if (res.success) {
    ...
    const documentObject = {
      content: [
        ...
        },
        {
          width: '*',
          text: [
            `CB, 209/1, Kachukhet Main Road, Dhaka Cantt. Dhaka-1206, Phone: 017625533/01762555544, dokanmanagerdhaka@gmail.com `,
          ],
          style: 'p',
          margin: [0, 60, 0, 0],
          alignment: 'center',
